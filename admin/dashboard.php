							...
							<tbody>
								...
								<tr>
									...
									<td><?php
										...
										?> </td>
									<td><a href="reserve_details.php?id=<?php echo $row['reserve_id']; ?>" data-toggle="tooltip" data-placement="top" title="VIEW"><button class="btn btn-info btn-fab btn-sm" style="border-radius: 50px;"><i class="fa fa-info-circle"></i></button></a>
										<a href="approve_reserve.php?id=<?php echo $row['reserve_id']; ?>" data-toggle="tooltip" data-placement="top" title="APPROVE"><button class="btn btn-success btn-fab btn-sm" style="border-radius: 50px;"><i class="fa fa-check-circle"></i></button></a></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
